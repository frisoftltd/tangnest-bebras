<?php
/**
 * Legacy Bebras quiz engine, preserved from v1.0.0.
 * Do not add features here — new work goes into the CT Assessment modules (M2+).
 * Scheduled for removal once all courses migrate to [tnq_assess] shortcodes.
 *
...
require_once __DIR__ . '/questions/pre-questions.php';
require_once __DIR__ . '/questions/post-questions.php';

class TNQ_Legacy_Quiz {
	...
	private function pre_questions(): array {
		return tnq_legacy_pre_questions();
	}

	private function post_questions(): array {
		return tnq_legacy_post_questions();
	}
