...
require_once TNQ_PLUGIN_DIR . 'admin/class-admin-overview.php';
require_once TNQ_PLUGIN_DIR . 'admin/class-admin-results.php';
require_once TNQ_PLUGIN_DIR . 'admin/class-admin-student.php';
require_once TNQ_PLUGIN_DIR . 'admin/class-admin-email.php';
require_once TNQ_PLUGIN_DIR . 'admin/class-admin-settings.php';
