...
return [
	...
	[
		...
		'hint'         => 'The left and right sides touch at the middle line. The bottom touches both sides. The stem only touches the bottom. You need all three colours for the leaf parts!',
		'svg'          => 'leaf-colorable',
		'regions'      => [ 'left', 'right', 'bottom', 'stem' ],
		'adjacency'    => [
			[ 'left',   'right'  ],
			[ 'left',   'bottom' ],
			[ 'right',  'bottom' ],
